...
-   back-end, pbs, mysql, meilisearch: no domain (internal only) - the API is same-origin - the FE's Caddy proxies /api/_ and /socket.io/_ to the API_UPSTREAM build arg - back-end:4000 by default (in the compose file)
