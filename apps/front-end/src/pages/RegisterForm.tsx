...
const registerSchema = z
  .object({
    firstName: z.string().min(1, "Please enter your first name").max(100, "Must be at most 100 characters"),
    lastName: z.string().min(1, "Please enter your last name").max(100, "Must be at most 100 characters"),
  ...
  return (
    <Card className="relative mx-auto mt-24 w-[calc(100vw-40px)] gap-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)] md:w-190">
      ...
      <CardContent className="px-6">
        ...
        <h3 className="mb-2! text-primary!">Account details</h3>
        ...
        <h3 className="mb-2! text-primary!">Organisation details</h3>
        <div className="mb-6 grid grid-cols-1 gap-x-4 gap-y-3 md:grid-cols-2">
          <Controller
            control={control}
            name="organisation"
          ...
          {organisationType === "community-interest" && (
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="gap-1.25">
                  <FieldLabel htmlFor="organisationCommunityInterest" className="text-left">
          ...
          {organisationType === "commercial" && (
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="gap-1.25">
                  <FieldLabel htmlFor="organisationCommercial" className="text-left">
                    Commercial type
                  </FieldLabel>
                  <Select
                    name="commercial"
          ...
          {organisationType === "commercial" && organisationCommercial === "other" && (
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="gap-1.25">
                  <FieldLabel htmlFor="organisationCommercialOther" className="text-left">
        ...
        <h3 className="mb-2! text-primary!">Access tiers</h3>
